...
int main() {
    ...
    std::string str("Bershka");
    SellingGoodsAccounter accounter1((char*)str.c_str(), 123, 123, 123);
    SellingGoodsAccounter accounter2((char*)str.c_str(), 321, 123, 123);


    std::cout << "Initial objects" << std::endl;
    std::cout << accounter1 << std::endl;
    std::cout << accounter2 << std::endl;

    auto temp = accounter2 + accounter1;
    std::cout << "Sum of fields of two objects:\n" << temp << std::endl;

    std::cout << "Are two objects equal? - " << (bool (accounter2 == accounter1)) << std::endl;
    std::cout << "Are fields of sum object bigger than in initial object? - " << (bool (accounter2 < temp)) << std::endl;
    std::cout << "How many goods are there in first accounter? - " << long(accounter1) << std::endl;
    std::cout << "How many goods are there in second accounter? - " << long(accounter2) << std::endl;
