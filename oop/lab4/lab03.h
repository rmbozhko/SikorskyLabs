...
public:
    ...
    explicit operator long() const { return getGoodsNumber(); }
    friend SellingGoodsAccounter operator+(SellingGoodsAccounter &lAccounter, SellingGoodsAccounter &rAccounter);
    friend bool operator==(SellingGoodsAccounter &lAccounter, SellingGoodsAccounter &rAccounter);
    friend bool operator<(SellingGoodsAccounter &lAccounter, SellingGoodsAccounter &rAccounter);
};
